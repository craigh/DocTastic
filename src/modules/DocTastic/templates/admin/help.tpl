...
<div id='doctastic_help_container'>
    ...
    <a class='doctastic_helplink' href="{modurl modname='DocTastic' type='user' func='view' docmodule=$topmodule}">
	<span class='z-icon-es-info'>{gt text='Full Documentation'}</span>
    </a>
