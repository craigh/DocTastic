...
<div class='doctastic_container'>
    <div class='doctasticpageicon'>{img modname='core' set='icons/large' src='info.gif'}</div>
    ...
    {if $document}
    <div>
        <div class='doctasticpageicon'>{img modname='core' set='icons/large' src='filenew.gif'}</div>
